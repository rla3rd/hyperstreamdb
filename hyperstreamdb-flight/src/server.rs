...
use arrow_flight::sql::{
    ...
    CommandStatementUpdate, TicketStatementQuery, SqlInfo,
};
use arrow_flight::{
...
impl FlightSqlService for HyperStreamFlightSqlService {
    ...
    async fn do_get_fallback(
        ...
        Err(Status::unimplemented(format!("do_get_fallback not implemented for: {:?}", message.type_url)))
    }
    ...
    async fn get_flight_info_sql_info(
        ...
        builder.append(SqlInfo::FlightSqlServerName, "HyperStreamDB Flight SQL Server");
        builder.append(SqlInfo::FlightSqlServerVersion, "1");
        builder.append(SqlInfo::FlightSqlServerArrowVersion, "1.3");
        let sql_info_data = builder.build().map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn do_get_statement(
        ...
        let flight_data_stream = arrow_flight::utils::batches_to_flight_data(
            &schema,
            batches
        ).map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn do_get_sql_info(
        ...
        data_builder.append(SqlInfo::FlightSqlServerName, "HyperStreamDB Flight SQL Server");
        data_builder.append(SqlInfo::FlightSqlServerVersion, "1");
        data_builder.append(SqlInfo::FlightSqlServerArrowVersion, "1.3");
        let sql_info_data = data_builder.build().map_err(|e| Status::internal(e.to_string()))?;

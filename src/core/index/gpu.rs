    ...
    pub fn from_device_str(device: &str) -> Result<Self> {
        ...
        match trimmed {
            ...
            _ if trimmed.starts_with("cuda:") => {
                let id = trimmed.strip_prefix("cuda:").unwrap().parse::<usize>().unwrap_or(0);
            ...
            _ if trimmed.starts_with("rocm:") => {
                let id = trimmed.strip_prefix("rocm:").unwrap().parse::<usize>().unwrap_or(0);
            ...
            _ if trimmed.starts_with("intel:") => {
                let id = trimmed.strip_prefix("intel:").unwrap().parse::<usize>().unwrap_or(0);

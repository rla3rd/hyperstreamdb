...
use std::any::Any;
use std::sync::Arc;
use arrow::array::{Array, ArrayRef, Float32Array, Float64Array, FixedSizeListArray, Int32Array, Int64Array, ListBuilder, Float32Builder, ListArray, UInt8Array};
        ...
        match &args.args[0] {
            ColumnarValue::Array(arr) => {
                if let Some(fsl) = arr.as_any().downcast_ref::<FixedSizeListArray>() {
                    ...
                    let results: arrow::array::Int32Array = (0..fsl.len()).map(|_| Some(len)).collect();

...
//! Sparse vector conversion UDFs and sparse utility functions.

use std::any::Any;
use std::sync::Arc;
use arrow::array::{ArrayRef, Float32Array, FixedSizeListArray, ListBuilder, Float32Builder, ListArray};
        ...
        match &args.args[0] {
            ColumnarValue::Array(arr) => {
                ...
                for i in 0..fixed_list.len() {
                    ...
                    // Use dense_to_sparse from sibling distance module

...
use arrow::array::{Array, ArrayRef, Float32Array, Float64Array, FixedSizeListArray, Int8Array, Int16Array, Int32Array, Int64Array, ListArray, UInt8Array, UInt16Array, UInt32Array, UInt64Array};
...
mod sparse_distance_tests {
    ...
    fn test_sparse_l2_distance_basic() {
        let a = SparseVector { indices: vec![0, 2], values: vec![1.0, 3.0], dim: 4 };
        let b = SparseVector { indices: vec![1, 3], values: vec![2.0, 4.0], dim: 4 };
    ...
    fn test_sparse_inner_product_distance_basic() {
        let a = SparseVector { indices: vec![0, 2], values: vec![1.0, 3.0], dim: 4 };
        let b = SparseVector { indices: vec![0, 2], values: vec![2.0, 4.0], dim: 4 };
